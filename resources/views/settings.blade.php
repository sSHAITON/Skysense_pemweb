        ...
        <div class="flex-1">
            <div class="flex items-center justify-center min-h-screen">
                <main class="w-full px-8">
                    @if ($component === 'userprofilesettings')
                        @include('components.userprofilesettings')
                    @elseif($component === 'wardrobesettings')
                        @include('components.wardrobesettings')
                    @elseif($component === 'userdevicesettings')
                        @include('components.userdevicesettings')
                    @endif
                </main>
            </div>
        </div>
