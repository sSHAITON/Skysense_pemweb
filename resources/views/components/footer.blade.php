<div class="mt-8 bg-blue-400 pt-9">
    <div class="mx-auto w-full max-w-[1166px] px-4 xl:px-0">
        <div class="flex flex-col justify-between sm:px-[1.125rem] md:flex-row md:px-10">
            <div class="md:w-[19.75rem]">
                <img src="{{ asset('img/logoskysense.png') }}" alt="SkySense Logo" class="h-24">
                <p class="text-[0.9375rem] font-normal text-white/[80%]">Dedicated to delivering
                    cutting-edge
                    weather monitoring solutions. Stay informed, stay prepared, and take control of your environment.
                </p>
            </div>
            <div class="md:w-[19.75rem]">
                <div class="mt-[1.4375rem] flex">
                    <div class="flex h-[2.375rem] w-[2.375rem] items-center justify-center rounded-[75%]">
                    ...
                    <div class="ml-[1.125rem]">
                        <a href="https://wa.me/+6282120884410"
                            class="font-Inter text-[0.875rem] font-medium text-white">+62
                            821-2088-4410</a>
                        <p class="font-Inter text-[0.75rem] font-medium text-white">Support Number</p>
                    </div>
                </div>
                <div class="mt-[1.4375rem] flex">
                    <div class="flex h-[2.375rem] w-[2.375rem] items-center justify-center rounded-[75%]">
                    ...
                    <div class="ml-[1.125rem]">
                        <a href="mailto:skysens@gmail.com"
                            class="font-Inter text-[0.875rem] font-medium text-[#fff]">skysense@gmail.com</a>
                        <p class="font-Inter text-[0.75rem] font-medium text-[#fff]">Support Email</p>
                    </div>
                </div>
                <div class="mt-[1.4375rem] flex">
                    <div class="flex h-[2.375rem] w-[2.375rem] items-center justify-center rounded-[75%]">
                    ...
                    <div class="ml-[1.125rem]">
                        <a href="https://maps.app.goo.gl/X1q4AVqyfrkJ4BF4A"
                            class="font-Inter text-[0.875rem] font-medium text-[#fff]">Bandung,
                            Indonesia</a>
                        <p class="font-Inter text-[0.75rem] font-medium text-white">Address</p>
                    </div>
                </div>
            </div>
            <div class="mt-6 flex w-full flex-col justify-between text-white sm:flex-row md:mt-0 md:max-w-[21.3125rem]">
                <div class="">
                    <p class="text-deutziawhite font-inter text-[1.125rem] font-medium leading-normal">Pages</p>
                    <ul>
                        <li class="mt-[0.9375rem]"><a
                                class="text-deutziawhite hover:text-deutziawhite/80 font-inter text-[0.9375rem] font-normal hover:font-semibold"
                                href="/">Home</a></li>
                        <li class="mt-[0.9375rem]"><a
                                class="text-deutziawhite hover:text-deutziawhite/80 font-inter text-[0.9375rem] font-normal hover:font-semibold"
                                href="/livedata">Live Data</a></li>
                        <li class="mt-[0.9375rem]"><a
                                class="text-deutziawhite hover:text-deutziawhite/80 font-inter text-[0.9375rem] font-normal hover:font-semibold"
                                href="#">Blog</a></li>
                        <li class="mt-[0.9375rem]"><a
                                class="text-deutziawhite hover:text-deutziawhite/80 font-inter text-[0.9375rem] font-normal hover:font-semibold"
                                href="/wardrobe">Wardrobe</a></li>
                    </ul>
                </div>
                <div class="mt-6 flex flex-col gap-4 sm:mt-0">
                    <p class="text-deutziawhite font-inter text-[1.125rem] font-medium">Download the app</p>
                    <div class="flex gap-4 sm:flex-col">
                        <a href="#"
                            class="flex items-center px-4 py-2 bg-black rounded-lg hover:bg-gray-800 transition-colors">
